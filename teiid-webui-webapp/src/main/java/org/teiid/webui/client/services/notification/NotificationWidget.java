 ...
 */
package org.teiid.webui.client.services.notification;
...
import org.teiid.webui.client.events.MouseInEvent.HasMouseInHandlers;
import org.teiid.webui.client.events.MouseOutEvent.HasMouseOutHandlers;
...
public class NotificationWidget extends Composite implements HasMouseInHandlers, HasMouseOutHandlers {
    ...
    public HandlerRegistration addMouseOutHandler(
            org.teiid.webui.client.events.MouseOutEvent.Handler handler) {
    ...
    public HandlerRegistration addMouseInHandler(
    		org.teiid.webui.client.events.MouseInEvent.Handler handler) {
